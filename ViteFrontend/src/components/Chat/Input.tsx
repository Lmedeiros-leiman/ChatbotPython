...
export const Input: React.FC<InputChatProps> = ({ onSend }) => {
    ...
    return (<form onSubmit={sendMessage} className="d-flex align-items-center">
        ...
        <button type="submit" disabled={ message.trim() === "" } value="" className=" cursor-pointer outline-none border-0 bg-transparent ">
